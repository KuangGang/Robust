 ...
 */
class ConvertUtils {
    private static final String FILTER_START = "META-INF";
        ...
        inputs.each {
            it.directoryInputs.each {
                ...
                org.apache.commons.io.FileUtils.listFiles(it.file, null, true).each {
                    if (it.absolutePath.endsWith(SdkConstants.DOT_CLASS)) {
                        ...
                        if (!className.startsWith(FILTER_START)) {
            ...
            it.jarInputs.each {
                ...
                while (classes.hasMoreElements()) {
                    ...
                    if (className.endsWith(SdkConstants.DOT_CLASS) && !className.startsWith(FILTER_START)) {
